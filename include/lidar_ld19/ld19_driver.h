...
#ifndef LIDAR_LD19_LD19_DRIVER_H
#define LIDAR_LD19_LD19_DRIVER_H

#include <Arduino.h>
#include <vector>

#include "lidar_ld19/ld19_data.h"
...
private:
    ...
    LD19Data ld19_data_;
    LidarPoint lidar_point_[12];
    Ld19RawData ld19_raw_data_;
    ...
    constexpr static uint8_t CrcTable[256] = {
        ...
        0x06, 0x4b, 0x9c, 0xd1, 0x7f, 0x32, 0xe5, 0xa8, 0x03, 0x4e, 0x99, 0xd4, 0x7c, 0x31, 0xe6, 0xab,
        0x05, 0x48, 0x9f, 0xd2, 0x8e, 0xc3, 0x14, 0x59, 0xf7, 0xba, 0x6d, 0x20, 0xd5, 0x98, 0x4f, 0x02,
        0xac, 0xe1, 0x36, 0x7b, 0x27, 0x6a, 0xbd, 0xf0, 0x5e, 0x13, 0xc4, 0x89, 0x63, 0x2e, 0xf9, 0xb4,
        0x1a, 0x57, 0x80, 0xcd, 0x91, 0xdc, 0x0b, 0x46, 0xe8, 0xa5, 0x72, 0x3f, 0xca, 0x87, 0x50, 0x1d,
        0xb3, 0xfe, 0x29, 0x64, 0x38, 0x75, 0xa2, 0xef, 0x41, 0x0c, 0xdb, 0x96, 0x42, 0x0f, 0xd8, 0x95
    };
     ...
     * @return uint8_t 
     */
    uint8_t CalcCRC(uint8_t *data, uint16_t &size);
};